...
class Dckuinojs {
  ...
  _parse(toParse) {
    ...
    for (var i = 0; i < lineArray.length; i++) {
      ...
      switch (wordOne) {
          ...
          if (this.checked) {
            ...
            for (var k = 0; k < arr2.length; k++) {
              ...
              if (arr3.length == 3 && textStringAlt !== "") {
                ...
                console.error(
                  "Error: at line: " + (i + 1) + ", altSTRING needs a text"
                );
                return;
              }
            }
        ...
        case "STRING":
          ...
          if (textString !== "") {
            ...
            console.error(
              "Error: at line: " + (i + 1) + ", STRING needs a text"
            );
            return;
          }
          break;
        case "DELAY":
          ...
          if (wordArray[0] === undefined || wordArray[0] === "") {
            console.error(
              "Error: at line: " + (i + 1) + ", DELAY needs a time"
            );
            return;
          }
          if (!isNaN(wordArray[0])) {
            ...
            console.error(
              "Error: at line: " + (i + 1) + ", DELAY only acceptes numbers"
            );
            return;
          }
          break;
        case "TYPE":
          ...
          if (keyMap[wordArray[0]] !== undefined) {
            ...
            console.error(
              "Error: Unknown letter '" + wordArray[0] + "' at line: " + (i + 1)
            );
            return;
          }
          break;
        case "REM":
          ...
          if (wordArray[0] !== undefined && wordArray[0] !== "") {
            ...
            console.error(
              "Error: at line: " + (i + 1) + ", REM needs a comment"
            );
            return;
          }
          break;
        ...
        case "REPLAY":
          ...
          if (wordArray[0] === undefined || wordArray[0] === "") {
            console.error(
              "Error: at line: " +
                (i + 1) +
                ", REPEAT/REPLAY needs a loop count"
            );
            return;
          }
          if (lastLines === undefined) {
            console.error(
              "Error: at line: " +
                (i + 1) +
                ", nothing to repeat, this is the first line."
            );
            return;
          }
          if (!isNaN(wordArray[0])) {
            ...
            console.error(
              "Error: at line: " +
                (i + 1) +
                ", REPEAT/REPLAY only acceptes numbers"
            );
            return;
          }
          break;
        default:
          ...
          while (wordArray.length) {
            if (comboMap[wordArray[0]] !== undefined) {
              ...
              releaseAll = true;
              parsedOut +=
                "  Keyboard.press(" + comboMap[wordArray[0]] + ");\n";
            } else if (commandMap[wordArray[0]] !== undefined) {
              commandKnown = true;
              releaseAll = true;
              parsedOut +=
                "  Keyboard.press(" + commandMap[wordArray[0]] + ");\n";
      ...
      if (releaseAll) parsedOut += "  Keyboard.releaseAll();\n";
      parsedScript += parsedOut;
      if (i != lineArray.length - 1) parsedScript += "\n";
    }
